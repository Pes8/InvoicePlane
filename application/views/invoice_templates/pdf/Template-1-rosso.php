...
<header class="clearfix">
    ...
    <div id="company">
        <div><b><span class="logo-red"><?php echo $invoice->user_company; ?></span></b></div>
        <div><span class="logo-red"><?php echo $invoice->user_address_1; ?> <?php echo $invoice->user_city . '(' . $invoice->user_state .')'. ' - ' . $invoice->user_zip; ?></span></div>
        <?php 
            if(!empty($invoice->user_address_2)):
        ?>
            <div><span class="logo-red"><?php echo $invoice->user_address_2; ?></span></div>
        <?php
            endif;
        ?>
        ...
        <?php if(!empty($invoice->user_vat_id)): ?><div><span class="small-text">P.IVA: </span><span class="logo-red"><?php echo $invoice->user_vat_id; ?></span></div><?php endif; ?>
        <?php if(!empty($invoice->user_tax_code)): ?><div><span class="small-text">Cod.Fisc: </span><span class="logo-red"><?php echo $invoice->user_tax_code; ?></span></div><?php endif; ?>
        <?php if(!empty($invoice->user_email)): ?><div><span class="small-text">Email: </span><span class="logo-red"><?php echo $invoice->user_email; ?></span></div><?php endif; ?>
        <?php if(!empty($invoice->user_web)): ?><div><span class="small-text">Sito: </span><span class="logo-red"><?php echo $invoice->user_web; ?></span></div><?php endif; ?>
